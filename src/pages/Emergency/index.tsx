  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#182B42] pb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                <span className="text-[11px] font-mono-tech text-[#00D4FF] font-semibold uppercase tracking-wider block">
                  Decision Support & Response Prioritization Matrix
                </span>
                <span className="text-[10px] font-mono-tech px-2 py-0.5 rounded bg-[#F59E0B]/20 text-[#F59E0B] border border-[#F59E0B]/40 font-bold">
          ...
          <p className="text-xs font-sans text-slate-300 mt-1">
            Simulated disaster-response and decision-support prototype console for DDMA, SDRF, NDRF, and District Magistrates. All agency rosters, shelter capacities, and dispatches represent demonstration data.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <Button
            ...
            variant="secondary"
            size="sm"
            icon={<Navigation className="w-3.5 h-3.5 text-[#00D4FF]" />}
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        <div className="p-3.5 rounded-xl bg-[#0E1A2C] border border-[#EF4444]/40 shadow-lg">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono-tech uppercase text-slate-400 font-bold">Priority 1 Threat</span>
            <span className="w-2 h-2 rounded-full bg-[#EF4444] animate-ping" />
          </div>
          <div className="text-xl font-extrabold text-[#EF4444] font-mono-tech mt-1">
        ...
        <div className="p-3.5 rounded-xl bg-[#0E1A2C] border border-[#182B42] shadow-lg">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono-tech uppercase text-slate-400 font-bold">Population at Risk</span>
            <Users className="w-3.5 h-3.5 text-[#14E6C5]" />
          </div>
        ...
        <div className="p-3.5 rounded-xl bg-[#0E1A2C] border border-[#182B42] shadow-lg">
          <div className="flex items-center justify-between">
            ...
            <Home className="w-3.5 h-3.5 text-[#00D4FF]" />
          </div>
          <div className="text-xl font-extrabold text-[#00D4FF] font-mono-tech mt-1">
            9 Active Hubs
          </div>
          <span className="text-[10px] text-slate-400 font-sans mt-0.5 block">
        ...
        <div className="p-3.5 rounded-xl bg-[#0E1A2C] border border-[#182B42] shadow-lg">
          ...
          <div className="text-xl font-extrabold text-[#F97316] font-mono-tech mt-1">
            NH-54, NH-06, NH-10
          </div>
          <span className="text-[10px] text-slate-400 font-sans mt-0.5 block">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-[#182B42] pb-3">
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${
              activeTabSub === 'PRIORITIES'
                ? 'bg-[#00D4FF] text-[#050912] shadow-[0_0_12px_rgba(0,212,255,0.4)]'
                : 'bg-[#0E1A2C] text-slate-300 hover:text-white border border-[#182B42]'
            }`}
          >
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 rounded-lg bg-[#07111F] border border-[#182B42] text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-[#00D4FF] w-48 sm:w-60 font-mono-tech"
            />
          </div>

          <div className="flex items-center gap-1 bg-[#07111F] border border-[#182B42] rounded-lg p-0.5 text-[11px] font-mono-tech">
            {(['ALL', 'CRITICAL', 'HIGH'] as const).map((lvl) => (
              <button
                ...
                className={`px-2 py-1 rounded transition-colors ${
                  severityFilter === lvl
                    ? 'bg-[#101D2E] text-[#00D4FF] font-bold'
        ...
        <div className="space-y-4">
          {filteredPriorities.map((item) => {
            ...
            return (
              <div
                key={item.rank}
                className={`p-5 rounded-2xl bg-[#0E1A2C] border transition-all space-y-4 shadow-xl relative overflow-hidden ${
                  isRank1
                    ? 'border-[#EF4444]/60 shadow-[0_0_20px_rgba(239,68,68,0.15)] ring-1 ring-[#EF4444]/30'
                    : 'border-[#182B42] hover:border-[#264366]'
                }`}
              >
                {/* Top Banner with Rank, Location, Risk Score */}
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pb-3 border-b border-[#182B42]">
                  <div className="flex items-start sm:items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-xs font-mono-tech px-2 py-0.5 rounded bg-[#07111F] text-[#00D4FF] border border-[#182B42] font-semibold">
                          ZONE {item.zoneCode}
                        </span>
                  ...
                  <div className="flex items-center gap-4 text-xs font-mono-tech flex-wrap bg-[#07111F] px-3.5 py-2 rounded-xl border border-[#182B42]">
                    <div>
                      <span className="text-[10px] text-slate-400 uppercase block">RISK SCORE</span>
                      <span className={`text-base font-extrabold ${
                        item.riskScore >= 90 ? 'text-[#EF4444]' : 'text-[#F97316]'
                      }`}>
                        {item.riskScore} <span className="text-xs text-slate-500 font-normal">/ 100</span>
                      </span>
                    </div>

                    <div className="h-7 w-[1px] bg-[#182B42]" />

                    <div>
                      <span className="text-[10px] text-slate-400 uppercase block">POPULATION AT RISK</span>
                      <span className="text-sm font-bold text-[#14E6C5]">
                    ...
                    <div>
                      <span className="text-[10px] text-slate-400 uppercase block">DISPATCH STATUS</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5">
                  ...
                  <div className="p-3.5 rounded-xl bg-[#07111F] border border-[#182B42] space-y-2">
                    <div className="flex items-center gap-1.5 text-[10px] font-mono-tech font-bold text-[#EF4444] uppercase tracking-wider">
                    ...
                    {item.contributingFactors && item.contributingFactors.length > 0 && (
                      <div className="pt-1">
                        <span className="text-[10px] font-mono-tech text-slate-400 block mb-1.5 uppercase">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {item.contributingFactors.map((factor, idx) => (
                            <span
                              key={idx}
                              className="text-[10px] font-mono-tech px-2 py-0.5 rounded bg-[#101D2E] text-slate-300 border border-[#182B42]"
                            >
                              • {factor}
                            </span>
                          ))}
                  ...
                  <div className="p-3.5 rounded-xl bg-[#07111F] border border-[#00D4FF]/30 space-y-2">
                    <div className="flex items-center gap-1.5 text-[10px] font-mono-tech font-bold text-[#00D4FF] uppercase tracking-wider">
                      <ShieldAlert className="w-3.5 h-3.5" />
                      RECOMMENDED RESPONSE DIRECTIVE
                    </div>
                    <div className="text-xs font-bold text-[#00D4FF] font-mono-tech">
                    ...
                    <div className="pt-1 border-t border-[#182B42] text-[11px] font-mono-tech text-slate-300 space-y-1">
                      {item.affectedRoads && (
                        <div>
                          <span className="text-slate-400 uppercase text-[10px]">AFFECTED ROAD: </span>
                          <span className="text-[#F97316] font-semibold">{item.affectedRoads}</span>
                        </div>
                      )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs font-mono-tech">
                  <div className="p-3 rounded-xl bg-[#101D2E]/60 border border-[#182B42]">
                  ...
                  <div className="p-3 rounded-xl bg-[#101D2E]/60 border border-[#182B42]">
                    ...
                    <span className="font-semibold text-[#14E6C5] mt-1 block">
                  ...
                  <div className="p-3 rounded-xl bg-[#101D2E]/60 border border-[#182B42]">
                    ...
                    <span className="font-semibold text-[#F97316] mt-1 block">
                ...
                {/* Action Bar */}
                <div className="flex items-center justify-between pt-2 border-t border-[#182B42] flex-wrap gap-2">
                  <div className="flex items-center gap-2">
                    <Button
          ...
          {filteredPriorities.length === 0 && (
            <div className="p-12 rounded-2xl bg-[#0E1A2C] border border-[#182B42] text-center space-y-3">
              <ShieldAlert className="w-8 h-8 text-slate-500 mx-auto" />
              <h4 className="text-base font-bold text-slate-300">No Priority Corridors Match Query</h4>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={idx} className="p-5 rounded-2xl bg-[#0E1A2C] border border-[#182B42] space-y-3.5 shadow-xl">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[10px] font-mono-tech px-2 py-0.5 rounded bg-[#10B981]/20 text-[#10B981] border border-[#10B981]/40 font-bold">
                    {sh.status}
                  </span>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="h-2 w-full bg-[#07111F] rounded-full overflow-hidden border border-[#182B42]">
                    <div
                      className="h-full bg-gradient-to-r from-[#00D4FF] to-[#14E6C5]"
                      style={{ width: `${(sh.occupied / sh.capacity) * 100}%` }}
                    />
                  </div>
                </div>

                <div className="text-xs font-mono-tech text-slate-300 space-y-1 pt-1 bg-[#07111F] p-2.5 rounded-xl border border-[#182B42]">
                  <div>
                    <span className="text-slate-500 uppercase text-[10px]">Medical: </span>
                    <span className="text-[#14E6C5] font-medium">{sh.medicalStaff}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 uppercase text-[10px]">Supplies: </span>
                    <span className="text-slate-300 font-medium">{sh.supplies}</span>
                  </div>
                </div>

                <div className="pt-2 border-t border-[#182B42] text-xs font-mono-tech text-slate-400 flex items-center justify-between">
                  <span>Emergency Helpline: <strong className="text-slate-200">{sh.contact}</strong></span>
                  <span className="text-[10px] text-[#00D4FF]">NDRF Verified</span>
                </div>
              </div>
            ))}
          </div>
      ...
      {activeTabSub === 'DETOURS' && (
        <div className="space-y-3">
          {[
            ...
            <div
              key={idx}
              className="p-5 rounded-2xl bg-[#0E1A2C] border border-[#182B42] flex flex-col lg:flex-row lg:items-center justify-between gap-4 text-xs font-mono-tech shadow-xl"
            >
              <div className="space-y-2 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="font-bold text-slate-100 text-sm font-sans">{d.corridor}</span>
                  <span className="text-[10px] text-slate-400 bg-[#07111F] px-2 py-0.5 rounded border border-[#182B42]">{d.state}</span>
              ...
              <div className="lg:text-right flex-shrink-0 bg-[#07111F] p-3 rounded-xl border border-[#182B42]">
                <span className="text-slate-400 uppercase text-[10px] block">ETA IMPACT</span>
                <span className="text-[#F97316] font-bold text-base">{d.etaIncrease}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      {activeTabSub === 'BROADCAST' && (
        <div className="p-6 rounded-2xl bg-[#0E1A2C] border border-[#182B42] shadow-xl space-y-6">
          <div className="flex items-center justify-between border-b border-[#182B42] pb-4">
            <div>
            ...
            <span className="text-[10px] font-mono-tech px-2.5 py-1 rounded bg-[#F59E0B]/20 text-[#F59E0B] border border-[#F59E0B]/30 font-bold">
              SIMULATED GATEWAY
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4 font-mono-tech text-xs">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(['SMS', 'CAP_XML', 'SIREN', 'WHATSAPP'] as const).map((ch) => (
                    <label key={ch} className="flex items-center gap-2 p-2 rounded-lg bg-[#07111F] border border-[#182B42] cursor-pointer">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[#07111F] border border-[#182B42] text-slate-100 focus:outline-none focus:border-[#00D4FF] font-sans text-xs"
                />
              </div>
              ...
              <Button
                ...
                className="w-full"
              >
                {isDispatching ? 'Dispatched to Gateway...' : 'Execute Multi-Channel Broadcast'}
              </Button>
            </div>
            ...
            <div className="space-y-4">
              ...
              {dispatchReceipt ? (
                <div className="p-4 rounded-xl bg-[#07111F] border border-[#10B981]/50 space-y-3 font-mono-tech text-xs">
                  <div className="flex items-center justify-between text-[#10B981]">
                    <span className="flex items-center gap-1 font-bold">
                      <CheckCircle2 className="w-4 h-4" /> BROADCAST DELIVERED
                    </span>
                    <span className="text-[10px] bg-[#10B981]/20 px-2 py-0.5 rounded">
                      {dispatchReceipt.status}
                    </span>
                  </div>

                  <div className="space-y-1 text-slate-300">
                    <div><span className="text-slate-500">DISPATCH ID:</span> <span className="text-[#00D4FF] font-bold">{dispatchReceipt.dispatchId}</span></div>
                    <div><span className="text-slate-500">ZONE:</span> {dispatchReceipt.zoneCode}</div>
                    <div><span className="text-slate-500">RECIPIENTS REACHED:</span> {dispatchReceipt.recipientCount} Citizens & Officers</div>
                    <div><span className="text-slate-500">CHANNELS:</span> {dispatchReceipt.channelsDispatched.join(', ')}</div>
                    <div><span className="text-slate-500">GATEWAY:</span> {dispatchReceipt.gateway}</div>
                    <div><span className="text-slate-500">TIMESTAMP:</span> {dispatchReceipt.timestamp}</div>
                  </div>
                </div>
              ) : (
                <div className="p-8 rounded-xl bg-[#07111F] border border-[#182B42] text-center space-y-2 font-mono-tech text-xs text-slate-500">
      ...
      {selectedForBroadcast && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-[#0E1A2C] border border-[#264366] rounded-2xl max-w-xl w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-[#182B42] pb-3">
              <div className="flex items-center gap-2">
                <span className="p-1.5 rounded-lg bg-[#EF4444]/20 text-[#EF4444] border border-[#EF4444]/40">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-200 text-sm font-mono-tech px-2 py-1"
              >
                ✕
              </button>
            </div>
            ...
            <div className="space-y-3 font-mono-tech text-xs">
              <div className="p-3 rounded-xl bg-[#07111F] border border-[#182B42]">
                <span className="text-[10px] text-slate-400 uppercase block">TARGET SECTOR</span>
              ...
              <div>
                ...
                <textarea
                  ...
                  value={broadcastMessage}
                  onChange={(e) => setBroadcastMessage(e.target.value)}
                  className="w-full px-3 py-2 rounded-lg bg-[#07111F] border border-[#182B42] text-slate-100 focus:outline-none focus:border-[#00D4FF] font-sans text-xs leading-relaxed"
                />
              </div>

              {dispatchReceipt && (
                <div className="p-3 rounded-xl bg-[#10B981]/15 border border-[#10B981]/40 text-[#10B981] text-xs space-y-1">
                  <div className="font-bold flex items-center gap-1">
                    <CheckCircle2 className="w-4 h-4" /> Broadcast Successfully Dispatched
                  </div>
                  <div className="text-[11px] text-slate-300">
                    Receipt: <code className="text-[#00D4FF]">{dispatchReceipt.dispatchId}</code> (48 recipients reached)
                  </div>
                </div>
              )}
            </div>

            <div className="flex items-center justify-end gap-3 pt-2 border-t border-[#182B42]">
              <Button
                onClick={() => setSelectedForBroadcast(null)}
                variant="secondary"
                size="sm"
              ...
              >
                {isDispatching ? 'Transmitting...' : 'Transmit Alert Now'}
              </Button>
            </div>
          </div>
        </div>
